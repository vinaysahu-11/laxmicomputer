  ...
  return (
    <div className="w-full bg-surface border border-outline-variant/60 rounded-2xl overflow-hidden shadow-sm">
      <div className="p-5 border-b border-outline-variant/60 bg-surface-container-low flex justify-between items-center">
        <h3 className="font-headline-sm text-headline-sm font-bold text-on-surface">Faculty List</h3>
        <span className="text-xs text-outline">Manage expert instructors</span>
      </div>
        ...
        <table className="w-full text-left border-collapse">
          <thead>
            <tr className="bg-surface-container-lowest text-on-surface-variant font-label-sm border-b border-outline-variant/40">
              <th className="p-4 uppercase tracking-wider font-semibold">Faculty ID</th>
              <th className="p-4 uppercase tracking-wider font-semibold">Name</th>
              <th className="p-4 uppercase tracking-wider font-semibold">Department</th>
              <th className="p-4 uppercase tracking-wider font-semibold">Classes</th>
          ...
          <tbody className="divide-y divide-outline-variant/20 text-body-sm font-light text-on-surface-variant">
            <tr>
              <td className="p-4 font-semibold">LCF-301</td>
              <td className="p-4 text-on-surface font-normal">Dr. Amit Verma</td>
              <td className="p-4">Coding & Web</td>
              <td className="p-4">Full Stack, Python</td>
              <td className="p-4">
